...
const translations = {
  en: {
    ...
    'notifications.pageTitle': 'Clean activity feed for attendance scans.',
    'notifications.pageDescription': 'Review website alerts in one focused page with scan status, time, performance information, and employee context.',
    'notifications.today': 'Today',
    'notifications.activity': 'Recent alerts',
    'notifications.activityDescription': 'The list updates automatically every 30 seconds so admin can watch attendance scans without refreshing.',
    'notifications.search': 'Search notifications',
    'notifications.unread': 'unread',
    'notifications.autoRefresh': 'Auto refresh',
    'notifications.loading': 'Loading notifications...',
    'notifications.empty': 'No website notifications yet.',
    'notifications.emptyDescription': 'When employees scan the daily QR code, the success alert will appear here.',
  ...
  km: {
    ...
    'notifications.pageTitle': 'ទំព័រសកម្មភាពស្អាតសម្រាប់ការស្កេនវត្តមាន។',
    'notifications.pageDescription': 'មើលការជូនដំណឹងនៅលើគេហទំព័រជាទំព័រតែមួយ មានស្ថានភាពស្កេន ម៉ោង ពិន្ទុការងារ និងព័ត៌មានបុគ្គលិក។',
    'notifications.today': 'ថ្ងៃនេះ',
    'notifications.activity': 'ការជូនដំណឹងថ្មីៗ',
    'notifications.activityDescription': 'បញ្ជីនេះអាប់ដេតស្វ័យប្រវត្តិរៀងរាល់ ៣០ វិនាទី ដើម្បីឱ្យអ្នកគ្រប់គ្រងមើលការស្កេនវត្តមានដោយមិនចាំបាច់ refresh។',
    'notifications.search': 'ស្វែងរកការជូនដំណឹង',
    'notifications.unread': 'មិនទាន់អាន',
    'notifications.autoRefresh': 'អាប់ដេតស្វ័យប្រវត្តិ',
    'notifications.loading': 'កំពុងផ្ទុកការជូនដំណឹង...',
    'notifications.empty': 'មិនទាន់មានការជូនដំណឹងនៅលើគេហទំព័រ។',
    'notifications.emptyDescription': 'នៅពេលបុគ្គលិកស្កេន QR ប្រចាំថ្ងៃ ការជូនដំណឹងជោគជ័យនឹងបង្ហាញនៅទីនេះ។',
